...
stocklist=stocklist[200:400] # WARNING remove if want to screen all stocks in list, want to check if you are allowed to scrape thousands of stock 
# print(stocklist)
...
for i in stocklist.index:
    ...
    try:
        ...
        if (cond_1 and cond_2 and cond_3 and cond_4 and cond_5 and cond_6 and cond_7):
            export_list = export_list.append({"Stock": stock, "50 Day MA": ma_50, "150 Day MA":ma_150, "200 Day MA":ma_200, "52 Week Low":low_52_wk, "52 Week High":high_52_wk},ignore_index=True)
        else:
